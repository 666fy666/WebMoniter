...
1. 在青龙面板 → **订阅管理** → **添加订阅**  
   ...
   - 定时规则：`0 0 * * *`（每日 0 点拉取一次）  
   - 白名单：`src/ql/*.py`  
   - 或直接填写需要的脚本，如：`src/ql/ikuuu_checkin.py,src/ql/tieba_checkin.py`

2. 或使用青龙内置命令拉取单个脚本：
   ```bash
   ql raw https://raw.githubusercontent.com/666fy666/WebMoniter/main/src/ql/ikuuu_checkin.py
   ```
...
3. 在青龙「定时任务」中新增任务：
   - 名称：iKuuu 签到
   - 命令：`task WebMoniter/src/ql/ikuuu_checkin.py`
   - 定时规则：`0 8 * * *`（每天 8:00）
...
#### iKuuu 签到 (`src/ql/ikuuu_checkin.py`)
...
#### 百度贴吧签到 (`src/ql/tieba_checkin.py`)
...
#### 雨云签到 (`src/ql/rainyun_checkin.py`)
...
#### 阿里云盘签到 (`src/ql/aliyun_checkin.py`)
...
#### 微博超话签到 (`src/ql/weibo_chaohua_checkin.py`)
...
- **名称**：iKuuu 签到
- **命令**：`task src/ql/ikuuu_checkin.py` 或 `task WebMoniter/src/ql/ikuuu_checkin.py`（取决于脚本路径）
- **定时规则**：`0 8 * * *`（每天 8:00）
...
| 脚本 | 说明 |
|------|------|
| `src/ql/ikuuu_checkin.py` | iKuuu 签到 |
| `src/ql/tieba_checkin.py` | 百度贴吧签到 |
| `src/ql/rainyun_checkin.py` | 雨云签到 |
| `src/ql/aliyun_checkin.py` | 阿里云盘签到 |
| `src/ql/weibo_chaohua_checkin.py` | 微博超话签到 |
| `src/ql/weather_push.py` | 天气推送 |
| `src/ql/enshan_checkin.py` | 恩山论坛签到 |
| `src/ql/tyyun_checkin.py` | 天翼云盘签到 |
| `src/ql/smzdm_checkin.py` | 什么值得买签到 |
| `src/ql/zdm_draw.py` | 值得买每日抽奖 |
| `src/ql/fg_checkin.py` | 富贵论坛签到 |
| `src/ql/miui_checkin.py` | 小米社区签到 |
| `src/ql/iqiyi_checkin.py` | 爱奇艺签到 |
| `src/ql/lenovo_checkin.py` | 联想乐豆签到 |
| `src/ql/lbly_checkin.py` | 丽宝乐园签到 |
| `src/ql/pinzan_checkin.py` | 品赞签到 |
| `src/ql/dml_checkin.py` | 达美乐任务 |
| `src/ql/xiaomao_checkin.py` | 小茅预约（i茅台） |
| `src/ql/ydwx_checkin.py` | 一点万象签到 |
| `src/ql/xingkong_checkin.py` | 星空代理签到 |
| `src/ql/freenom_checkin.py` | Freenom 续期 |
| `src/ql/qtw_checkin.py` | 千图网签到 |
| `src/ql/kuake_checkin.py` | 夸克网盘签到 |
| `src/ql/kjwj_checkin.py` | 科技玩家签到 |
| `src/ql/fr_checkin.py` | 帆软签到 |
| `src/ql/nine_nine_nine_task.py` | 999 会员中心 |
| `src/ql/zgfc_draw.py` | 中国福彩抽奖 |
| `src/ql/ssq_500w_notice.py` | 双色球开奖通知 |
